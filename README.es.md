...
|---|---:|---|
| ALLPOWERS R600 (`R600*`, `AP R*`) con firma de revisión verificada (`hardware_version=0.3`, `raw_hardware_version=0x03`) | Verificado | Objetivo principal de desarrollo y protocolo con controles de escritura habilitados. |
